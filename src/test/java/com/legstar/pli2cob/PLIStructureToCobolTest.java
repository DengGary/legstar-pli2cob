...
public class PLIStructureToCobolTest extends TestCase {
    ...
    /**
     * Sample from PL1 mailing list archive.
     */
    public void testMailistSample1() {
        executeCheck(
                "DCL 1 A ALIGNED,"
                + "   2 A1CHAR1 CHAR(1) ,"
                + "   2 A2FB15 FIXED BIN(15) ,"
                + "   2 A4CHAR1 CHAR(2) ,"
                + "   2 A5FB15 FIXED BIN(15),"
                + "   2 A6CHAR3 CHAR(3) ,"
                + "   2 A7FB31 FIXED BIN(31),"
                + "   2 A8CHAR3 CHAR(1) ,"
                + "   2 A9FB31 FIXED BIN(31) ;",
                ...
                + "           02 A4CHAR1 PIC X(2)." + '\n'
                + "           02 A5FB15 PIC S9(4) COMP-5." + '\n'
                + "           02 A6CHAR3 PIC X(3)." + '\n'
                + "           02 FILLER PIC X(1)." + '\n'
                + "           02 A7FB31 PIC S9(9) COMP-5." + '\n'
                + "           02 A8CHAR3 PIC X(1)." + '\n'
                + "           02 FILLER PIC X(3)." + '\n'
                + "           02 A9FB31 PIC S9(9) COMP-5." + '\n'
                + "\n"
                ,
                true,
                false);
